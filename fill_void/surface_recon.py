...
if __name__ == '__main__':
    # load point cloud
    pcd = o3d.io.read_point_cloud('aligned.ply')

    # down sample and filter outliers
    pcd_dsp = pcd.voxel_down_sample(0.025)
    cl, ind = pcd_dsp.remove_radius_outlier(nb_points=12, radius=0.05)
    ...
    ms.apply_coord_laplacian_smoothing_surface_preserving(iterations=5)
